...
<Sublayout pageName="Create comic">
  <div class="flex flex-col gap-6 px-10 min-w-[0]">
    <!-- Banner -->
    ...
    <div class="flex gap-6 w-full max-w-full min-w-[0]">
      <!-- Cover -->
                  ...
                  <div class="flex gap-2 w-full">
                    ...
                    <div class="join shrink-0">
                      <button
                        ...
                        class:btn-disabled={aliases.length >= 3 || aliases[index].trim() === ''}
                        class:text-neutral={aliases.length >= 3 || aliases[index].trim() === ''}
                        class:text-success={aliases.length < 3 && aliases[index].trim() !== ''}
                        on:click={() => (aliases = [...aliases, ''])}
                      >
