...
<Sublayout pageName="Privacy Policy">
  <div class="container-80 prose text-base-content pb-16">
    <p>Last updated: <time datetime="2024-08-02">August 02, 2024</time></p>
    <p>
    ...
    <ul>
      ...
      <li>
        <p>
          <strong>Application</strong> refers to Yomikaze, the software program provided by the Company.
        </p>
      </li>
      <li>
        <p>
          <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this
          Agreement) refers to Yomikaze.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Yomikaze, accessible from
          <a href="https://yomikaze.org" rel="external nofollow noopener" target="_blank"
            >https://yomikaze.org</a
          >
        </p>
      </li>
      <li>
    ...
    <p>
      ...
      You close Your web browser. Learn more about cookies on the <a
    ...
    <ul>
      <li>
        By visiting this page on our website: <a
          ...
          target="_blank">https://www.facebook.com/yomicomic/</a
        >
      </li>
    </ul>
  </div>
